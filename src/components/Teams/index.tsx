      ...
      <div className="container">
        <div className="w-full mx-auto text-center" style={{ maxWidth: "570px", marginBottom: "100px" }}>
          ...
          <p className="text-base leading-relaxed text-body-color md:text-lg">
            Meet the talented individuals who make our vision a reality. Our team is dedicated to delivering exceptional results and driving innovation.
          </p>
        </div>

        <div className="grid grid-cols-1 gap-x-8 gap-y-10 md:grid-cols-2 lg:grid-cols-4 lg:items-stretch">
          {teamData.map((member) => (
